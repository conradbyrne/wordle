...
public class WordleDictionary {
    ...
    public boolean isLegalWordleWord(String word) {
        if (word == null) {
            ...
            //URL: https://stackoverflow.com/questions/5238491/check-if-string-contains-only-letters
            //Description: the above link contains the method for checking if a string is letters, used down below
            //Lines: 58-65
