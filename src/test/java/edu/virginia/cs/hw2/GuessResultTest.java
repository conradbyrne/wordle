...
class GuessResultTest {
    ...
    @Test
    @DisplayName("Answer with no similar letters produces all gray")
    public void testLetterResultAllGray() {
        givenInputGuessAndAnswer("BBBBB", "MATCH");
    ...
    @Test
    @DisplayName("Answer with correct letters but all wrong position produces all yellow")
    public void testLetterResultAllYellow() {
        givenInputGuessAndAnswer("AMCHT", "MATCH");
    ...
    @Test
    @DisplayName("Answer has one yellow tile but guess had two of that letter")
    public void testLetterResultOnlyOneYellow() {
        givenInputGuessAndAnswer("ARROW", "MISER");
    ...
    @Test
    @DisplayName("Guess has 3 letters which are in answer twice")
    public void testLetterResultTwoYellows() {
        givenInputGuessAndAnswer("ABACA", "DAEAF");

        LetterResult[] guessResult = testGuessResult.getGuessResult();

        assertEquals("YgYgg", getLetterResultArrayAsString(guessResult));
    }

    @Test
    @DisplayName("One green square in answer for a letter, but guess uses 2 of that letter")
    public void testLetterResultOneYellowOneGreen() {
        givenInputGuessAndAnswer("TERSE", "PEPSI");
